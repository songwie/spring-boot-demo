...
public class CommonDAO implements ICommonDAO
{
     ...
     * @deprecated
     */
    public <T, ID extends Serializable> T findById(ID arg0, boolean arg1, Class<T> arg2)
    {
        return null;
    }
     ...
     * @deprecated
     */
    public <T> List<T> findAll(Class<T> arg0)
    {
        return null;
    }
    ...
    {
    	return this.getEntityManager().merge(arg0);
    }

    /**
     * @deprecated
     */
    public <T> void delete(T arg0)
    {
    	this.getEntityManager().remove(arg0);
    }
}
